function changerCouleur(obj){
    ...
    //En fonction de la couleur actuelle, changer de couleur
    switch(color){
        case "black": obj.style.color = "red" ;break;
        case "red": obj.style.color = "black" ;break;
        default: obj.style.color = "red" ;break;
    }
}


var p = document.getElementsByTagName("p"); //paragaphes
